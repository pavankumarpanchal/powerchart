 package com.ty.power_chart_app.util;
...
public class MyConfig {
	...
	public Docket getDocket() {
		...
		ApiInfo apiInfo = new ApiInfo("Car App RESTful Web Service documentation",
		...
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.ty.power_chart_app")).build().apiInfo(apiInfo)
