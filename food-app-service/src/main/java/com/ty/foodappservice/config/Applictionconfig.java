package com.ty.foodappservice.config;
...
public class Applictionconfig {
	...
	public Docket getDocket() {
		...
		ApiInfo apiInfo = new ApiInfo("Shopping kart RESTful Web Service documentation",
		...
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("com.ty.foodappservice")).build().apiInfo(apiInfo)
